...
<title>最新<?php echo ($list_name); ?>-<?php echo ($list_dir); ?><?php echo ($list_name_big); ?><?php echo ($list_name); ?>-2011最新<?php echo ($list_name); ?></title>
...
<div class="wrap">
    ...
    <div class="top960"><?php echo getadsurl('top960');?></div>
     <div class="box">
    	...
    	<?php if(($mod)  ==  "0"): ?></ul><?php if(in_array(($i), explode(',',"8,16,24,32,40,48,56,64,72,80,88,96,104,112"))): ?><ul class="hang1"><?php else: ?><ul class="hang2"><?php endif; ?><?php endif; ?><?php endforeach; endif; else: echo "" ;endif; ?></ul>
    </div>
    <div class="ft">
    <div class="ft_l">
