...
$(document).ready(function(){
	$("a").click(function(){
		//$("a").removeClass("leftover");
		//$(this).toggleClass("leftover");
		$("a").removeClass("on"); 
		$(this).addClass("on");
		$(this).blur();
	});
...
<a href="?s=Admin-Vod-Show-continu-1">连载中的影片</a>
<a href="?s=Admin-Vod-Show-status-2">未审核的影片</a>
<a href="?s=Admin-Vod-Show-status-3">相似待审核</a>
</div>
<div id="menu2" style="display:none">
<a href="?s=Admin-Xml-Show" class="on">一键采集视频</a>
<a href="?s=plus-dswin-show">定时自动采集</a>
<a href="?s=Admin-Cj-Show">视频采集规则</a>
<a href="?s=Admin-Cj-Add">添加采集规则</a>
<a href="?s=Admin-Cj-Change">栏目转换规则</a> 
</div>
<div id="menu3" style="display:none">
<a href="?s=Admin-Cache-Show" class="on">系统缓存管理</a>
<a href="?s=Admin-Slide-Show">首页幻灯管理</a>
<a href="?s=Admin-Slide-Add">添加首页幻灯</a>
...
<a href="?s=Admin-Admin-Show" class="on">后台用户管理</a>
<a href="?s=Admin-Admin-Add">添加后台用户</a>
<!--<a href="?s=Admin-User-Show">会员管理中心</a>
<a href="?s=Admin-User-Show">添加新用户</a>
<a href="?s=Admin-User-Addgroup">付费观看记录</a> -->
<a href="?s=Admin-Cm-Show">用户评论管理</a>
<a href="?s=Admin-Gb-Show">用户留言管理</a>
<a href="?s=Admin-Gb-Show-cid-1">影片报错管理</a>
</div>
...
<a href="http://union.feifeicms.com/feifei/jump.php?id=1">提高网站流量</a>
<a href="http://union.feifeicms.com/feifei/jump.php?id=2">推荐网站空间</a>
<a href="http://union.feifeicms.com/feifei/jump.php?id=3">推荐广告联盟</a> 
</div>
</td></tr>
<tr><td class="power">Powered by <a href="<?php echo L("ppvod_homeurl");?>" target="_blank">PPVOD</a></td></tr>
</table>
</body>
</html>