...
<div style="width:403px; height:46px; background:#166CA3;"><img src="__PUBLIC__/images/admin/login.gif" alt="管理登录" /></div>
...
<div style="width:401px !important; width:403px; height:30px; background:#F7F7E7; border:1px solid #649EB2; border-top:1px solid #ddd; margin-bottom:5px; font-size:12px; line-height:30px; font-family:'微软雅黑'">@2006-2012 PPVOD <?php echo L("ppvod_version");?></div>
