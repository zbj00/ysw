...
<div class="tabs" id="topmenu">
    ...
    <li><a href="?s=Admin-Admin-Show" target="right" onClick="Tabs(this,6)"><span>用户管理</span></a></li>
    <li><a href="?s=Admin-Data-Show" target="right" onClick="Tabs(this,7)"><span>数据库维护</span></a></li>
    <li><a href="http://union.feifeicms.com/feifei/jump.php?id=4" target="right" onClick="Tabs(this,8)"><span>站长资源</span></a></li>
</div>
<div class="tophr">
	<div class="left">你好：<?php echo $_SESSION["admin_name"];?>，<?php echo L("ppvod_welcome");?></div>
